...
```powershell
cd D:\Java\class\projectKu\codex-repo-guardrails\yingyue-cloud-feat-codex-repo-guardrails-20260623
mvn -pl backend/ruoyi-modules/ruoyi-yy -am test -Dtest=YyClientPublicApiServiceImplTest,YyPaymentServiceImplTest
```
