...
baseUrl: https://api.evanshine.me
photo smoke mode: explicit
auth: success (len=152, value=djF8...wbsY)
albums: success count=1
detail: success albumId=990202606080001, assetCount=4
thumbnail-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 11:17:35
preview-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 11:17:35
download-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 11:17:35
...
✔ empty active albums are labeled as waiting for upload (4.7893ms)
✔ albums with visible assets remain viewable for customers (0.4943ms)
✔ expired and disabled album status labels are still explicit (0.4611ms)
✔ album list empty and error states give operator-independent customer actions (1.9175ms)
✔ project delivery status script aggregates platform readiness and pickup release gate (3.3723ms)
✔ project delivery status script returns machine-readable blocked JSON for empty evidence (1173.1817ms)
✔ detail asset filters count selected pending and error photos (4.5249ms)
✔ detail asset filters return scoped asset lists (0.9823ms)
✔ detail asset filter empty copy gives customer next step (2.2274ms)
✔ detail selection sequence follows the customer selected order (0.699ms)
✔ detail selection summary reflects draft and submitted states (0.8549ms)
✔ detail selection summary can show backend delivery workflow states (0.4879ms)
✔ detail selection timeline copy formats backend submit time (2.6148ms)
✔ detail delivery next step gives customer an actionable state (0.8705ms)
✔ douyin life order entry page is registered for H5 and miniapps (5.4167ms)
✔ client API exposes public douyin life order entries without photo token (1.3515ms)
✔ login page links to public douyin life order entry page (1.4017ms)
✔ douyin order page can open or copy configured real landing entry (0.6864ms)
✔ friend takeover maps keep production and reference project boundaries explicit (4.8629ms)
✔ friend takeover maps pin official API domain and miniapp import outputs (3.3351ms)
✔ repo README points maintainers to the authoritative friend takeover entry (0.9592ms)
✔ reference project folders exist beside the production repo for map verification (2.6076ms)
✔ photo pickup smoke verifies thumbnail signed url before original preview and download (3.1037ms)
✔ photo pickup smoke can verify private OSS bare object is blocked (1.1435ms)
✔ production preflight passes private OSS verification options into photo smoke (0.9383ms)
✔ photo pickup smoke warns when public api is tested with local demo defaults (4.6303ms)
✔ photo pickup smoke has a preview account shortcut for public empty-album checks (1.4274ms)
✔ pickup login keeps customer trust cues visible (5.1562ms)
✔ pickup login explains the customer credential flow before entering albums (1.3176ms)
✔ album list shows a delivery dashboard before album cards (1.382ms)
✔ album list empty and failed states provide clear recovery actions (2.9599ms)
✔ empty album cover looks like a delivery proof instead of a broken image (1.2976ms)
✔ album detail summary uses customer-facing delivery language (1.7198ms)
✔ album detail exposes selection status filters (1.3636ms)
✔ album detail shows selected sequence and submission state copy (1.4703ms)
✔ album detail exposes delivery proof metrics above the photo grid (1.2397ms)
✔ album detail gives an actionable next step after delivery metrics (1.5972ms)
✔ album detail explains selection rules before customers submit retouch choices (1.2283ms)
✔ preview page explains swipe and private download behavior (1.6969ms)
✔ preview page shows file context and protected access proof (1.1653ms)
✔ preview page shows image position progress and save safety note (1.8059ms)
✔ result page gives diagnostic reason next step and safe pickup boundary (1.5208ms)
✔ wechat and douyin can show platform phone authorization entry (2.9203ms)
✔ phone authorization event extracts modern miniapp phone code (0.4904ms)
✔ platform login payload keeps only safe exchange fields (2.1732ms)
✔ platform phone authorization failures guide users back to pickup code (0.6857ms)
✔ login page exposes platform authorization UI without hiding pickup-code fallback (3.6912ms)
✔ platform readiness verifies miniapp build output files and project appids (3.0304ms)
✔ platform readiness prints devtools import paths and legal domain fill values (0.993ms)
✔ local acceptance runs platform readiness after miniapp builds (1.0206ms)
✔ local acceptance includes admin album management checks (1.4747ms)
✔ preview image error clears preview url and shows retry copy (2.8524ms)
✔ preview error help text gives a customer next step (3.0212ms)
✔ preview image load marks image ready and clears error copy (0.569ms)
✔ download is disabled when preview is unavailable (0.7146ms)
✔ download failure feedback gives customer and operator next steps (6.2799ms)
✔ miniapp save failure feedback separates cancel permission and system failures (2.016ms)
✔ customer-facing UI guards remain present in page templates (3.3547ms)
✔ detail preview signing failure moves asset into error state (0.6716ms)
✔ preview back target falls back to album detail on direct links (0.9644ms)
✔ detail preview signing batches prioritize first screen and chunk the rest (1.592ms)
✔ album cover signing batches can use smaller first screen limits (0.9419ms)
✔ detail preview progress reports failed assets separately from prepared assets (2.6301ms)
✔ real OSS evidence generator captures production photo pickup acceptance gates (8.6824ms)
✔ real OSS evidence generator captures PowerShell information stream output (1.7989ms)
✔ real OSS evidence summary verifier enforces handoff-ready JSON (3.299ms)
✔ real OSS evidence summary verifier reports unreadable or incomplete summaries clearly (1226.0595ms)
✔ real OSS evidence final pass requires preflight and local acceptance runs (629.9763ms)
✔ real OSS evidence summary verifier treats string false flags as not accepted (573.4593ms)
✔ real OSS evidence summary verifier rejects conclusion casing and whitespace drift (595.1042ms)
✔ latest real OSS evidence summary verifier gates release handoff (0.9383ms)
✔ real OSS runbooks document the latest-summary release gate (1.1634ms)
✔ photo pickup release gate requires local acceptance and real OSS final pass (2.0718ms)
✔ photo pickup release gate can report blocked status as JSON (669.2175ms)
✔ photo pickup release gate reports real OSS verifier failures as JSON (476.7952ms)
✔ photo pickup release gate reports child script exit failures as JSON (529.6101ms)
✔ photo pickup release gate treats skipped local acceptance as partial only (851.0992ms)
✔ photo pickup release gate stops early when release status is blocked (681.3657ms)
✔ photo pickup release status explains missing acceptance gates (1.402ms)
✔ photo pickup release status can print machine-readable JSON (514.8061ms)
✔ photo pickup release status can write a JSON artifact (572.8336ms)
✔ photo pickup release status handles legacy summaries without manual checks (605.0325ms)
✔ photo pickup release status handles partial manual check objects (627.1959ms)
✔ photo pickup release status handles corrupt summary json (519.1563ms)
✔ photo pickup release status handles summaries without conclusion fields (626.0392ms)
✔ photo pickup release status blocks final pass summaries without automatic runs (568.062ms)
✔ photo pickup release status blocks forged final pass summaries without evidence integrity (690.6699ms)
✔ real OSS evidence summary verifier rejects non-Aliyun OSS bare URLs (608.0924ms)
✔ photo pickup release status blocks non-Aliyun OSS bare URL summaries (707.062ms)
✔ photo pickup release status blocks summaries with missing real OSS input ids (609.0984ms)
✔ photo pickup release status treats string false flags as not accepted (670.0568ms)
✔ deploy package carries photo pickup release evidence gates (0.9413ms)
✔ photo pickup access audit verifier checks required actions with redacted output (0.6017ms)
✔ deploy package verifier enforces handoff package contents (0.9938ms)
✔ deploy package builder documents package verification JSON artifact handoff (0.3002ms)
✔ deploy package verifier rejects forbidden secret filenames in package (1930.5736ms)
✔ deploy package verifier reports missing package as machine-readable JSON (513.42ms)
✔ result state normalizes unknown types to info (3.7789ms)
✔ result state gives actionable error diagnostics (2.5971ms)
✔ result state gives warning and info next steps (0.7263ms)
✔ result redirect sends errors to login and non-errors back to albums or redirect (0.7427ms)
✔ result redirect sanitizes unsafe error redirect targets (0.5167ms)
✔ client photo api exposes a separate thumbnail signed url endpoint (2.7191ms)
✔ thumbnail signed url falls back to preview signed url when backend lacks thumbnail endpoint (0.9917ms)
✔ miniapp image display uses api-domain stream temp files instead of direct OSS signed urls (2.9499ms)
✔ album directory and cover use thumbnails while preview keeps preview metadata (1.302ms)
ℹ tests 106
ℹ suites 0
ℹ pass 106
ℹ fail 0
...
<== mobile WeChat mini build passed in 11.0s
...
[1m[46m RUN [49m[22m [36mv4.0.18 [39m[90mD:/OtherProject/CameraApp/yingyue-cloud-repo/admin-ui[39m
 ...
 [32m✓[39m src/views/yy/utils/photoPageContract.test.ts [2m([22m[2m24 tests[22m[2m)[22m[32m 39[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/orderPageContract.test.ts [2m([22m[2m12 tests[22m[2m)[22m[32m 19[2mms[22m[39m
 ...
 [32m✓[39m src/views/yy/utils/photoUpload.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 19[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/photoOperationsHealth.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 18[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/photoPickupEntry.test.ts [2m([22m[2m12 tests[22m[2m)[22m[32m 84[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/douyinLifePageContract.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 8[2mms[22m[39m
...
[2m   Start at [22m 11:08:47
[2m   Duration [22m 1.92s[2m (transform 3.70s, setup 0ms, import 5.80s, tests 213ms, environment 7ms)[22m

<== admin yy tests passed in 13.6s
...
<== admin dev build passed in 61.8s

==> backend photo pickup smoke
photo pickup smoke
baseUrl: https://api.evanshine.me
photo smoke mode: explicit
auth: success (len=152, value=djF8...iOiU)
albums: success count=1
detail: success albumId=990202606080001, assetCount=4
thumbnail-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 11:19:50
preview-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 11:19:50
download-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 11:19:50
stream: success status=200, contentType=image/jpeg, contentDisposition=attachment; filename="yingyue-demo-01-retouch-cover.jpg"; filename*=UTF-8''yingyue-demo-01-retouch-cover.jpg, bytes=70314
<== backend photo pickup smoke passed in 2.0s
...
[INFO] Tests run: 14, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 5.379 s -- in org.dromara.yy.service.impl.YyClientPhotoServiceImplTest
[INFO]
[INFO] Results:
[INFO]
...
[INFO]
[INFO] RuoYi-Vue-Plus ..................................... SUCCESS [  1.254 s]
[INFO] ruoyi-common ....................................... SUCCESS [  0.136 s]
[INFO] ruoyi-common-core .................................. SUCCESS [  1.358 s]
[INFO] ruoyi-common-json .................................. SUCCESS [  0.282 s]
[INFO] ruoyi-common-redis ................................. SUCCESS [  0.579 s]
[INFO] ruoyi-common-ratelimiter ........................... SUCCESS [  0.237 s]
[INFO] ruoyi-common-satoken ............................... SUCCESS [  0.258 s]
[INFO] ruoyi-common-mybatis ............................... SUCCESS [  0.459 s]
[INFO] ruoyi-common-oss ................................... SUCCESS [  0.402 s]
[INFO] ruoyi-common-log ................................... SUCCESS [  0.193 s]
[INFO] ruoyi-common-excel ................................. SUCCESS [  0.283 s]
[INFO] ruoyi-common-tenant ................................ SUCCESS [  0.220 s]
[INFO] ruoyi-common-security .............................. SUCCESS [  0.191 s]
[INFO] ruoyi-common-web ................................... SUCCESS [  0.271 s]
[INFO] ruoyi-common-idempotent ............................ SUCCESS [  0.182 s]
[INFO] ruoyi-common-encrypt ............................... SUCCESS [  0.189 s]
[INFO] ruoyi-modules ...................................... SUCCESS [  0.081 s]
[INFO] ruoyi-yy ........................................... SUCCESS [  8.037 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  15.640 s
[INFO] Finished at: 2026-06-11T11:10:11+08:00
[INFO] ------------------------------------------------------------------------
<== backend client photo unit tests passed in 18.4s

photo pickup local acceptance: passed
exit_code: 0
finished: 2026-06-11 11:10:11
```
...
```powershell
cd D:\OtherProject\CameraApp\yingyue-cloud-repo
.\tools\verify-photo-pickup-real-oss-summary.ps1 -SummaryJsonPath "D:\OtherProject\CameraApp\yingyue-cloud-repo\docs\evidence\photo-pickup-real-oss-acceptance-20260611-110734.json"
```
...
```powershell
cd D:\OtherProject\CameraApp\yingyue-cloud-repo
.\tools\verify-photo-pickup-real-oss-summary.ps1 -SummaryJsonPath "D:\OtherProject\CameraApp\yingyue-cloud-repo\docs\evidence\photo-pickup-real-oss-acceptance-20260611-110734.json" -RequireFinalPass
```
