...
baseUrl: https://api.evanshine.me
photo smoke mode: explicit
auth: success (len=152, value=djF8...QfsA)
albums: success count=1
detail: success albumId=990202606080001, assetCount=4
thumbnail-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 22:54:40
preview-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 22:54:41
download-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 22:54:41
...
✔ empty active albums are labeled as waiting for upload (3.5881ms)
✔ albums with visible assets remain viewable for customers (0.5292ms)
✔ expired and disabled album status labels are still explicit (0.5387ms)
✔ album list empty and error states give operator-independent customer actions (4.7468ms)
✔ project delivery status script aggregates platform readiness and pickup release gate (5.3989ms)
✔ project delivery status script returns machine-readable blocked JSON for empty evidence (1194.8705ms)
✔ detail asset filters count selected pending and error photos (6.5266ms)
✔ detail asset filters return scoped asset lists (0.8458ms)
✔ detail asset filter empty copy gives customer next step (2.1397ms)
✔ detail selection sequence follows the customer selected order (0.7262ms)
✔ detail selection summary reflects draft and submitted states (0.8828ms)
✔ detail selection summary can show backend delivery workflow states (0.5824ms)
✔ detail selection timeline copy formats backend submit time (2.2614ms)
✔ detail delivery next step gives customer an actionable state (1.2857ms)
✔ douyin life order entry page is registered for H5 and miniapps (3.4957ms)
✔ client API exposes public douyin life order entries without photo token (1.3856ms)
✔ login page links to public douyin life order entry page (1.483ms)
✔ douyin order page can open or copy configured real landing entry (2.5458ms)
✔ friend takeover maps keep production and reference project boundaries explicit (5.9304ms)
✔ friend takeover maps pin official API domain and miniapp import outputs (4.0221ms)
✔ repo README points maintainers to the authoritative friend takeover entry (1.0773ms)
✔ reference project folders exist beside the production repo for map verification (4.3853ms)
✔ photo pickup smoke verifies thumbnail signed url before original preview and download (3.8509ms)
✔ photo pickup smoke can verify private OSS bare object is blocked (1.054ms)
✔ production preflight passes private OSS verification options into photo smoke (0.9653ms)
✔ photo pickup smoke warns when public api is tested with local demo defaults (2.3831ms)
✔ photo pickup smoke has a preview account shortcut for public empty-album checks (1.8261ms)
✔ pickup login keeps customer trust cues visible (6.7272ms)
✔ pickup login explains the customer credential flow before entering albums (1.5113ms)
✔ album list shows a delivery dashboard before album cards (1.2713ms)
✔ album list empty and failed states provide clear recovery actions (2.9148ms)
✔ empty album cover looks like a delivery proof instead of a broken image (1.2413ms)
✔ album detail summary uses customer-facing delivery language (1.3209ms)
✔ album detail exposes selection status filters (1.0991ms)
✔ album detail shows selected sequence and submission state copy (2.0478ms)
✔ album detail exposes delivery proof metrics above the photo grid (1.7039ms)
✔ album detail gives an actionable next step after delivery metrics (3.9054ms)
✔ album detail explains selection rules before customers submit retouch choices (1.271ms)
✔ preview page explains swipe and private download behavior (2.0936ms)
✔ preview page shows file context and protected access proof (1.193ms)
✔ preview page shows image position progress and save safety note (1.4411ms)
✔ result page gives diagnostic reason next step and safe pickup boundary (1.3594ms)
✔ wechat and douyin can show platform phone authorization entry (2.9956ms)
✔ phone authorization event extracts modern miniapp phone code (0.7215ms)
✔ platform login payload keeps only safe exchange fields (1.8796ms)
✔ platform phone authorization failures guide users back to pickup code (0.5003ms)
✔ login page exposes platform authorization UI without hiding pickup-code fallback (3.037ms)
✔ platform readiness verifies miniapp build output files and project appids (2.4299ms)
✔ platform readiness prints devtools import paths and legal domain fill values (7.3543ms)
✔ local acceptance runs platform readiness after miniapp builds (1.2075ms)
✔ local acceptance includes admin album management checks (0.9724ms)
✔ miniapp acceptance handoff prints exact external verification checklist (2.5053ms)
✔ latest miniapp handoff evidence records only remaining external blockers (1.1261ms)
✔ preview image error clears preview url and shows retry copy (4.4604ms)
✔ preview error help text gives a customer next step (2.5756ms)
✔ preview image load marks image ready and clears error copy (0.6039ms)
✔ download is disabled when preview is unavailable (1.3424ms)
✔ download failure feedback gives customer and operator next steps (5.4813ms)
✔ miniapp save failure feedback separates cancel permission and system failures (1.0907ms)
✔ customer-facing UI guards remain present in page templates (3.6496ms)
✔ detail preview signing failure moves asset into error state (1.7054ms)
✔ preview back target falls back to album detail on direct links (0.7124ms)
✔ detail preview signing batches prioritize first screen and chunk the rest (1.6202ms)
✔ album cover signing batches can use smaller first screen limits (2.0448ms)
✔ detail preview progress reports failed assets separately from prepared assets (0.7786ms)
✔ real OSS evidence generator captures production photo pickup acceptance gates (9.2976ms)
✔ real OSS evidence generator captures PowerShell information stream output (2.9827ms)
✔ real OSS evidence summary verifier enforces handoff-ready JSON (1.8464ms)
✔ real OSS evidence summary verifier reports unreadable or incomplete summaries clearly (1191.9241ms)
✔ real OSS evidence final pass requires preflight and local acceptance runs (539.8712ms)
✔ real OSS evidence summary verifier treats string false flags as not accepted (542.9728ms)
✔ real OSS evidence summary verifier rejects conclusion casing and whitespace drift (543.3093ms)
✔ latest real OSS evidence summary verifier gates release handoff (1.03ms)
✔ real OSS runbooks document the latest-summary release gate (1.7957ms)
✔ photo pickup release gate requires local acceptance and real OSS final pass (1.3441ms)
✔ photo pickup release gate can report blocked status as JSON (582.4342ms)
✔ photo pickup release gate reports real OSS verifier failures as JSON (513.0355ms)
✔ photo pickup release gate reports child script exit failures as JSON (526.3822ms)
✔ photo pickup release gate treats skipped local acceptance as partial only (789.688ms)
✔ photo pickup release gate stops early when release status is blocked (717.639ms)
✔ photo pickup release status explains missing acceptance gates (1.3229ms)
✔ photo pickup release status can print machine-readable JSON (541.1274ms)
✔ photo pickup release status can write a JSON artifact (579.9541ms)
✔ photo pickup release status handles legacy summaries without manual checks (565.8963ms)
✔ photo pickup release status handles partial manual check objects (556.3743ms)
✔ photo pickup release status handles corrupt summary json (503.7935ms)
✔ photo pickup release status handles summaries without conclusion fields (537.8052ms)
✔ photo pickup release status blocks final pass summaries without automatic runs (586.5867ms)
✔ photo pickup release status blocks forged final pass summaries without evidence integrity (579.9741ms)
✔ real OSS evidence summary verifier rejects non-Aliyun OSS bare URLs (608.7385ms)
✔ photo pickup release status blocks non-Aliyun OSS bare URL summaries (607.433ms)
✔ photo pickup release status blocks summaries with missing real OSS input ids (578.3753ms)
✔ photo pickup release status treats string false flags as not accepted (607.4191ms)
✔ deploy package carries photo pickup release evidence gates (1.4467ms)
✔ photo pickup access audit verifier checks required actions with redacted output (0.7556ms)
✔ deploy package verifier enforces handoff package contents (1.3045ms)
✔ deploy package builder documents package verification JSON artifact handoff (0.5309ms)
✔ deploy package verifier rejects forbidden secret filenames in package (1824.3007ms)
✔ deploy package verifier reports missing package as machine-readable JSON (466.5253ms)
✔ result state normalizes unknown types to info (4.3356ms)
✔ result state gives actionable error diagnostics (2.705ms)
✔ result state gives warning and info next steps (0.7782ms)
✔ result redirect sends errors to login and non-errors back to albums or redirect (0.6706ms)
✔ result redirect sanitizes unsafe error redirect targets (0.4894ms)
✔ client photo api exposes a separate thumbnail signed url endpoint (2.0637ms)
✔ thumbnail signed url falls back to preview signed url when backend lacks thumbnail endpoint (0.9606ms)
✔ miniapp image display uses api-domain stream temp files instead of direct OSS signed urls (2.648ms)
✔ album directory and cover use thumbnails while preview keeps preview metadata (1.0168ms)
ℹ tests 108
ℹ suites 0
ℹ pass 108
ℹ fail 0
...
ℹ skipped 0
ℹ todo 0
ℹ duration_ms 15553.5845
<== mobile unit tests passed in 16.2s
...
DONE  Build complete.
<== mobile H5 build passed in 14.0s
...
<== mobile WeChat mini build passed in 10.8s
...
<== mobile Douyin mini build passed in 15.2s
...
[1m[46m RUN [49m[22m [36mv4.0.18 [39m[90mD:/OtherProject/CameraApp/yingyue-cloud-repo/admin-ui[39m
 ...
 [32m✓[39m src/views/yy/utils/douyinLifePageContract.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 10[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/orderPageContract.test.ts [2m([22m[2m13 tests[22m[2m)[22m[32m 19[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/photoPageContract.test.ts [2m([22m[2m24 tests[22m[2m)[22m[32m 30[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/douyinLife.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 13[2mms[22m[39m
 [32m✓[39m src/views/yy/utils/photoUpload.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 20[2mms[22m[39m
 ...
 [32m✓[39m src/views/yy/utils/homePageContract.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 8[2mms[22m[39m
...
[2m   Start at [22m 22:45:55
[2m   Duration [22m 2.18s[2m (transform 7.19s, setup 0ms, import 7.95s, tests 202ms, environment 8ms)[22m

<== admin yy tests passed in 13.3s
...
[32m✓ built in 58.14s[39m
<== admin dev build passed in 68.6s

==> backend photo pickup smoke
photo pickup smoke
baseUrl: https://api.evanshine.me
photo smoke mode: explicit
auth: success (len=152, value=djF8...YW-0)
albums: success count=1
detail: success albumId=990202606080001, assetCount=4
thumbnail-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 22:57:08
preview-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 22:57:09
download-url: success assetId=1781018145736000012, fileName=yingyue-demo-01-retouch-cover.jpg, contentType=image/jpeg, expiresAt=2026-06-11 22:57:10
stream: success status=200, contentType=image/jpeg, contentDisposition=attachment; filename="yingyue-demo-01-retouch-cover.jpg"; filename*=UTF-8''yingyue-demo-01-retouch-cover.jpg, bytes=70314
<== backend photo pickup smoke passed in 5.0s
...
[INFO] Tests run: 14, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 5.384 s -- in org.dromara.yy.service.impl.YyClientPhotoServiceImplTest
[INFO]
[INFO] Results:
[INFO]
...
[INFO]
[INFO] RuoYi-Vue-Plus ..................................... SUCCESS [  1.239 s]
[INFO] ruoyi-common ....................................... SUCCESS [  0.108 s]
[INFO] ruoyi-common-core .................................. SUCCESS [  1.473 s]
[INFO] ruoyi-common-json .................................. SUCCESS [  0.220 s]
[INFO] ruoyi-common-redis ................................. SUCCESS [  0.677 s]
[INFO] ruoyi-common-ratelimiter ........................... SUCCESS [  0.162 s]
[INFO] ruoyi-common-satoken ............................... SUCCESS [  0.250 s]
[INFO] ruoyi-common-mybatis ............................... SUCCESS [  0.477 s]
[INFO] ruoyi-common-oss ................................... SUCCESS [  0.411 s]
[INFO] ruoyi-common-log ................................... SUCCESS [  0.168 s]
[INFO] ruoyi-common-excel ................................. SUCCESS [  0.241 s]
[INFO] ruoyi-common-tenant ................................ SUCCESS [  0.181 s]
[INFO] ruoyi-common-security .............................. SUCCESS [  0.173 s]
[INFO] ruoyi-common-web ................................... SUCCESS [  0.321 s]
[INFO] ruoyi-common-idempotent ............................ SUCCESS [  0.143 s]
[INFO] ruoyi-common-encrypt ............................... SUCCESS [  0.142 s]
[INFO] ruoyi-modules ...................................... SUCCESS [  0.065 s]
[INFO] ruoyi-yy ........................................... SUCCESS [  8.148 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  15.576 s
[INFO] Finished at: 2026-06-11T22:47:29+08:00
[INFO] ------------------------------------------------------------------------
<== backend client photo unit tests passed in 18.3s

photo pickup local acceptance: passed
exit_code: 0
finished: 2026-06-11 22:47:29
```
...
```powershell
cd D:\OtherProject\CameraApp\yingyue-cloud-repo
.\tools\verify-photo-pickup-real-oss-summary.ps1 -SummaryJsonPath "D:\OtherProject\CameraApp\yingyue-cloud-repo\docs\evidence\photo-pickup-real-oss-acceptance-20260611-224437.json"
```
...
```powershell
cd D:\OtherProject\CameraApp\yingyue-cloud-repo
.\tools\verify-photo-pickup-real-oss-summary.ps1 -SummaryJsonPath "D:\OtherProject\CameraApp\yingyue-cloud-repo\docs\evidence\photo-pickup-real-oss-acceptance-20260611-224437.json" -RequireFinalPass
```
