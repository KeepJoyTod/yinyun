...
GeneratedAt: 2026-06-16 01:37:34 +08:00
...
| Output | D:\OtherProject\CameraApp\yingyue-cloud-repo\docs\evidence\studio-workbench-acceptance-20260616-013734.md |

## Route Probes

| Route | Status | HTTP | URL | Detail |
| --- | --- | --- | --- | --- |
| /,/login,/order/appointment,/dashboard/today,/settings/logs,/order/verification | FAIL | 0 | https://studio.evanshine.me/,/login,/order/appointment,/dashboard/today,/settings/logs,/order/verification | 无法连接到远程服务器 |
