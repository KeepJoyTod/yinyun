...
-- 依赖：已先执行 yy_cloud.sql。
-- ----------------------------

insert ignore into yy_store
...
values
(902001, '000000', 900001, 'YY202606010001', '李女士', '13800001111', 'LOCAL', 'MANUAL', now(), date_add(now(), interval 1 day), 'PENDING', 'A01', '', 103, 1, now(), 1, now(), '0', 'B-029 待确认预约订单'),
(902002, '000000', 900001, 'YY202606010002', '张先生', '13800002222', 'DOUYIN', 'CHANNEL', date_sub(now(), interval 2 hour), now(), 'ARRIVED', 'A02', 'DY-20260601-0002', 103, 1, now(), 1, now(), '0', '抖音渠道到店订单'),
(902003, '000000', 900002, 'YY202605310003', '王女士', '13800003333', 'MEITUAN', 'CHANNEL', date_sub(now(), interval 1 day), date_sub(now(), interval 3 hour), 'COMPLETED', 'B01', 'MT-20260531-0003', 103, 1, now(), 1, now(), '0', '已完成并进入选片'),
(902004, '000000', 900002, 'YY202606010004', '赵女士', '13800004444', 'LOCAL', 'H5', date_sub(now(), interval 1 hour), date_add(now(), interval 2 day), 'CONFIRMED', 'B02', '', 103, 1, now(), 1, now(), '0', 'H5 已确认预约'),
(902005, '000000', 900001, 'YY202606010005', '周女士', '13800005555', 'WECHAT', 'MINI_APP', now(), date_add(now(), interval 3 day), 'CONFIRMED', 'A03', 'WX-20260601-0005', 103, 1, now(), 1, now(), '0', '微信小程序预约样例');

insert ignore into yy_photo_album
...
values
(903001, '000000', 900002, 902003, '王女士亲子套系选片', '王女士', '13800003333', 'demo-album-wang-202606', 'PICK-202606-001', 'H5', 'ACTIVE', 'SELECTING', '', '', '', date_add(now(), interval 14 day), 103, 1, now(), 1, now(), '0', 'C-020 底片/在线选片样例'),
(903002, '000000', 900001, 902002, '张先生写真底片', '张先生', '13800002222', 'demo-album-zhang-202606', 'PICK-202606-002', 'DOUYIN_LIFE', 'ACTIVE', 'WAITING', 'DY-LIFE-20260601-0002', 'CERT-202606-002', 'BOOK-202606-002', date_add(now(), interval 7 day), 103, 1, now(), 1, now(), '0', '待客户选片样例');

insert ignore into yy_photo_asset
...
insert ignore into yy_photo_access_log
...
insert ignore into yy_photo_verify_code
...
values
(904201, '000000', '13800003333', '123456', 'PHOTO_PICKUP', 'H5', date_add(now(), interval 5 minute), null, 'CREATED', '127.0.0.1', 103, 1, now(), 1, now(), '0', '取片验证码样例');

insert ignore into yy_channel_plugin
...
insert ignore into yy_channel_account
...
insert ignore into yy_channel_product_mapping
...
insert ignore into yy_channel_order_mapping
...
values
(908001, '000000', 900001, 902002, 'DOUYIN', 'DY-20260601-0002', 'UNOPENED', 'PENDING', json_object('source', 'demo', 'channel', 'douyin'), 103, 1, now(), 1, now(), '0', '抖音订单同步占位'),
(908002, '000000', 900002, 902003, 'MEITUAN', 'MT-20260531-0003', 'VERIFIED', 'SYNCED', json_object('source', 'demo', 'channel', 'meituan'), 103, 1, now(), 1, now(), '0', '美团订单核销占位'),
(908003, '000000', 900001, 902005, 'WECHAT', 'WX-20260601-0005', 'PENDING', 'PENDING', json_object('source', 'demo', 'channel', 'wechat'), 103, 1, now(), 1, now(), '0', '微信预约同步占位'),
(908004, '000000', 900002, 902004, 'DOUYIN_LIFE', 'DY-LIFE-20260601-0004', 'PAY_SUCCESS', 'PENDING', json_object('source', 'demo', 'channel', 'douyin_life'), 103, 1, now(), 1, now(), '0', '抖音来客订单同步占位');

insert ignore into yy_channel_sync_log
...
insert ignore into yy_service_group
...
insert ignore into yy_schedule_rule
...
insert ignore into yy_employee
...
insert ignore into yy_customer
...
(913002, '000000', '王女士', '13800003333', '2', null, 'MEITUAN', 'VIP', 2, 899.00, now(), '亲子,选片', 103, 1, now(), 1, now(), '0', '渠道客户样例');

insert ignore into yy_notification_template
...
insert ignore into yy_notification_log
...
values
(915001, '000000', 900001, 902001, 913001, 914001, 'WECHAT', '13800001111', 'PENDING', 'REQ-NOTICE-DEMO-001', '微信服务商未配置', null, json_object('scene', 'booking_confirmed'), 103, 1, now(), 1, now(), '0', '通知日志样例'),
(915002, '000000', 900002, 902003, 913002, 914002, 'WECHAT', '13800003333', 'SENT', 'REQ-NOTICE-DEMO-002', '', now(), json_object('scene', 'photo_selection_ready'), 103, 1, now(), 1, now(), '0', '通知日志样例');

insert ignore into yy_report_snapshot
...
values
(916001, '000000', 900001, current_date(), 'DAILY', 3, 1, 0, 199.00, 0.00, json_object('LOCAL', 2, 'DOUYIN', 1), 103, 1, now(), 1, now(), '0', '门店日报快照样例'),
(916002, '000000', 900002, current_date(), 'DAILY', 2, 1, 1, 899.00, 120.00, json_object('MEITUAN', 1, 'H5', 1), 103, 1, now(), 1, now(), '0', '门店日报快照样例');

insert ignore into yy_mobile_channel_config
