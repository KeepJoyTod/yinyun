create table if not exists yy_collaboration_setting (
    ...
    constraint uk_yy_collaboration_setting_type unique (tenant_id, setting_type, del_flag)
);
...
create table if not exists yy_product_collaboration_config (
    ...
    update_by bigint,
    update_time timestamp,
    constraint uk_yy_product_collaboration_config_product unique (tenant_id, product_id, del_flag)
);
