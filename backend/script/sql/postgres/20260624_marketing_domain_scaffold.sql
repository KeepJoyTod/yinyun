...
CREATE TABLE IF NOT EXISTS yy_campaign_participation (
  ...
  stage VARCHAR(32),
  participation_status VARCHAR(32) DEFAULT 'REGISTERED',
  conversion_status VARCHAR(32) DEFAULT 'PENDING',
  refund_status VARCHAR(32) DEFAULT 'NONE',
  invalid_reason VARCHAR(255),
  participated_at VARCHAR(32),
